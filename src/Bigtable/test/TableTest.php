...
class TableTest extends TestCase
{
    ...
    {
        $PagedListResponse = new PagedListResponse();
        $mock = $this->createMock(BigtableTable::class);
        $mock->method('listTables')
             ->willReturn($PagedListResponse);
        $list = $mock->listTables(Argument::type('string'));
        $this->assertInstanceOf(PagedListResponse::class, $list);
    }
    ...
    public function MutateRows()
    {
        ...
        $mock = $this->createMock(BigtableTable::class);
        $mock->method('mutateRows')
             ->willReturn($ServerStream);

        $mutateRows = $mock->mutateRows(Argument::type('string'), Argument::type('array'));
        $this->assertInstanceOf(ServerStream::class, $mutateRows);
    }
...
// $BigtableTableTest->mutateRowsRequest();
?>
